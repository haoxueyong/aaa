    ...
    <div class="col-md-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-file-o"></i> <?= $EX['FileName'] ?></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-4 border-right">
              <div class="user-block">
                <!-- <img class="img-circle img-bordered-sm" src="/images/icos/file_detail.png" alt="user image"/> -->
                  <span class="ico fa fa-file-o text-gray" ></span>
                  ...
                  <span class="description">
                    <span>路径：</span>
                    <span><?= $EX['FilePath'] ?></span>
                  </span>
                  <span class="description">
                    <span>大小：</span>
                    <span ng-bind="EX.Detail.sizeStr"></span>
                  </span>
                  <span class="description">
                    <span>威胁描述：</span>
                    <span><?= $EX['Detail']['desc'] ?></span>
                  </span>
              </div>
              <div class="user-block">
              ...
              <div class="user-block" style="border-top: 1px solid #f4f4f4;">
                <!-- <img class="img-circle img-bordered-sm fa fa-file-o" src="/images/icos/computer _detail.png" alt="user image"/> -->
            ...
            <!-- #f4f4f4 -->
              <div class="user-block">
                <span class="description text">
                    <span>创建日期：</span>
                    <span><?= date('Y-m-d H:i:s',$EX['Detail']['create_date']/1000) ?></span>
                  </span>
                  <span class="description text">
                    <span>签名：</span>
                    <span><?= $EX['Detail']['is_signed']? '有' : '无' ?></span>
                  </span>
                  <span class="description text">
                    <span>签名者：</span>
                    <span><?= $EX['Detail']['signer'] ?></span>
                  </span>
                  <span class="description text">
                    <span>网络连接：</span>
                    <span><?= $EX['Detail']['is_net']? '有' : '无' ?></span>
                  </span>
                  <span class="description text">
                    <span>威胁来源：</span>
                    <?php
            ...
            <div class="col-md-4 ng-cloak">
              ...
              <button ng-click="updata('setWhite')" class="btn btn-success" ng-if="EX.status != 3 && EX.status != 2">加入白名单</button>
