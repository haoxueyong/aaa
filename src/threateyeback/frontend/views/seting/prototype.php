...
?>
<!-- Main content -->
<section class="content" ng-app="myApp" ng-controller="PrototypeCtrl">
  <div class="row">
    <div class="col-xs-12">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="Prototype">
            ...
            <section ng-if="!nowPrototype">
              ...
              <div class="row">
                <div class="col-lg-2 col-sm-4 col-xs-6 ng-cloak" ng-repeat="(name,item) in prototypes.red">
            ...
            <section ng-if="!nowPrototype">
              ...
              <div class="row">
                <div class="col-lg-2 col-sm-4 col-xs-6 ng-cloak" ng-repeat="(name,item) in prototypes.green">
                  <div class="small-box" style="cursor: pointer;" ng-class="item.node ? bgList[$index%7] : 'bg-gray'" ng-click="detail(item);">
                    <div class="inner">
                      <h3 ng-bind="item.lengthNum"></h3>
