...
#link mysql config
sudo rm /etc/my.cnf
sudo ln -s /home/www/conf/my.cnf /etc/my.cnf

#link php config
sudo rm /etc/php.ini
sudo ln -s /home/www/conf/php.ini /etc/php.ini
sudo rm /etc/php-cli.ini
sudo ln -s /home/www/conf/php-cli.ini /etc/php-cli.ini
sudo rm /usr/local/php/etc/php-fpm.conf
sudo ln -s /home/www/conf/php-fpm.conf /usr/local/php/etc/php-fpm.conf

# link redis config
sudo rm /usr/local/redis/etc/redis.conf
sudo ln -s /home/www/conf/redis.conf /usr/local/redis/etc/redis.conf


# link nginx config
sudo rm /usr/local/nginx/conf/nginx.conf
sudo ln -s /home/www/conf/nginx.conf /usr/local/nginx/conf/nginx.conf
